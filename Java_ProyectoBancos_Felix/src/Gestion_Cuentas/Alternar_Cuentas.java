...
public class Alternar_Cuentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Bancos Felits - Activación de Cuentas");
        ...
        Title.setText("Activación de Cuentas");
        ...
        BotonAlt.setText("Activar/Desactivar");
    ...
    private void BotonBuscarCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarCuentaActionPerformed
        ...
        if (TextEstado.getText().equals("Activa"))
            BotonAlt.setText("Desactivar Cuenta");
        else
            BotonAlt.setText("Activar Cuenta");
    ...
    private void BotonAltActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAltActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "¿Está seguro que quiere "+est+" esta cuenta?", "Confirmación", JOptionPane.YES_NO_OPTION,
        JOptionPane.WARNING_MESSAGE) == JOptionPane.YES_OPTION) {
            ...
            mdcu.AlternarCuenta(est, TextCuenta.getText());
            mb.IngresarBitacora(cocl.DBFecha(fs.fecha()), Vista_Principal.Iniciar_Sesion.pUser, "El usuario "+msg+" la cuenta "+TextCuenta.getText());
            if (est == "Activa") est = "activada"; else est = "desactivada";
            try {
                CbCuenta.removeAllItems();
            } catch (Exception e) {
                System.out.println(e);
            ...
            mdcu.MostrarDatosCuenta(TextCuenta.getText(), TextFecha, TextSaldo, TextMonto, TextEstado, Signo, RadioCorriente, RadioAhorro, RadioColones, RadioDolar);
            JOptionPane.showMessageDialog(null, "La cuenta fue "+est+".", "Solicitud finalizada", JOptionPane.PLAIN_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Alternar_Cuentas().setVisible(true);
            }
        });
    }
