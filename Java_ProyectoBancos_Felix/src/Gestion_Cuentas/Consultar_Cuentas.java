...
public class Consultar_Cuentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Bancos Felits - Consulta de Cuentas");
        ...
        Title.setText("Consulta de Cuentas");
        ...
        TextSaldo.setCaretColor(new java.awt.Color(255, 255, 255));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(TextCuenta, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_Cuentas().setVisible(true);
            }
        });
    }
