...
public class Anular_Moves extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Bancos Felits - Anulación de Movimientos");
        ...
        Title.setText("Anulación de Movimientos");
        ...
        CbMoves.setForeground(new java.awt.Color(255, 255, 255));
        ...
        TextNumMov.setForeground(new java.awt.Color(255, 255, 255));
        ...
        BotonAnular.setBackground(new java.awt.Color(0, 98, 152));
        BotonAnular.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        BotonAnular.setForeground(new java.awt.Color(255, 255, 255));
        BotonAnular.setText("Anular Movimiento");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(TextNumMov)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(BotonBuscarMov))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(TextFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(RadioReti, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE))))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(TextMonto, javax.swing.GroupLayout.PREFERRED_SIZE, 268, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(BotonAnular, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(BotonLimpiar, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void BotonBuscarMovActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarMovActionPerformed
        ...
        if ((TextNumMov.getText().equals(""))) {
            ...
            if (enco == 1) {
                ...
                com.BloquearTodoConsultar(TextID, TextCuenta, TextNumMov, CbClientes, CbCuenta, CbMoves, BotonBuscar, BotonConsultarO, BotonBuscarCuenta, BotonOtroMov, BotonBuscarMov);
            } else {
    ...
    private void BotonAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAnularActionPerformed
        ...
        if (RadioDepo.isSelected() == true)
            ...
            tipmov = "Depósito";
        mb.IngresarBitacora(cocl.DBFecha(fs.fecha()), Vista_Principal.Iniciar_Sesion.pUser, "El usuario anuló el movimiento "+TextNumMov.getText());
        mdm.AnularMove(TextNumMov.getText(), TextCuenta.getText(), TextMonto.getText(), tipmov);
        int s = CbCuenta.getSelectedIndex();
        try {
            CbCuenta.removeAllItems();
        } catch (Exception e) {
            System.out.println(e);
        ...
        CbCuenta.setSelectedIndex(s);
        com.ConsultarOtroMov(TextNumMov, TextFecha, TextMonto, TextNombreResp, TextDetalle, TipoMov);
        com.BuscandoMov(TextID, TextCuenta, TextNumMov, CbClientes, CbCuenta, CbMoves, BotonBuscar, BotonConsultarO, BotonBuscarCuenta, BotonOtroMov, BotonBuscarMov);
        CbMoves.removeItemAt(CbMoves.getSelectedIndex());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Anular_Moves().setVisible(true);
            }
        });
    }
