...
public class Activar_Users extends javax.swing.JFrame {
    ...
    public Activar_Users() {
        initComponents();
        mdu.CargarCbUsers(CbUsers);
        cou.BloquearActivar(CbUsers, TextUser, jButton1, BotonAlt);
    }
    ...
    private void initComponents() {
        ...
        BotonAlt = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Bancos Felits - Activación de Usuarios");
        ...
        jLabel1.setText("Activación Usuarios");
        ...
        BotonAlt.setBackground(new java.awt.Color(0, 98, 152));
        BotonAlt.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        BotonAlt.setForeground(new java.awt.Color(255, 255, 255));
        BotonAlt.setText("Desactivar/Activar");
        BotonAlt.setFocusPainted(false);
        BotonAlt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotonAltActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(53, 53, 53)
                        .addComponent(BotonLimp, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(50, 50, 50)
                        .addComponent(BotonAlt)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(BotonAlt, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(12, 12, 12))
        );
    ...
    private void TogContraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TogContraActionPerformed
        //Procedimiento para mostrar y esconder una contraseña
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (mdu.buscarusername(TextUser.getText()) == 1) {
            ...
            JOptionPane.showMessageDialog(null, "Usuario encontrado, se mostrarán sus datos", "Estado", JOptionPane.PLAIN_MESSAGE);
            cou.DesbloquearActivar(CbUsers, TextUser, jButton1, BotonAlt);
            if (TextEstado.getText().equals("Activo"))
                BotonAlt.setText("Desactivar");
            else
                BotonAlt.setText("Activar");
        } else {
            JOptionPane.showMessageDialog(null, "El usuario no está registrado.", "Estado", JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void BotonAltActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAltActionPerformed
        String est, msg;
        
        if (TextEstado.getText().equals("Activa")) {
            est = "desactivar";
            msg = "desactivó";
        } else {
            est = "activar";
        ...
        if (JOptionPane.showConfirmDialog(null, "¿Está seguro que quiere "+est+" este usuario?", "Confirmación", JOptionPane.YES_NO_OPTION,
        JOptionPane.WARNING_MESSAGE) == JOptionPane.YES_OPTION) {
            if (TextEstado.getText().equals("Activo")) {
                est = "Inactivo";
                BotonAlt.setText("Activar Usuario");
            }
            else {
                est = "Activo";
                BotonAlt.setText("Desactivar Usuario");
            }
            mdu.AlternarUsuario(TextUser.getText(), est);
            mb.IngresarBitacora(cocl.DBFecha(fs.fecha()), Vista_Principal.Iniciar_Sesion.pUser, "El usuario "+msg+" al usuario "+TextUser.getText());
            if (est.equals("Activo")) est = "activado"; else est = "desactivado";
            mdu.MostrarDatos(TextUser.getText(), TextPass, TextName, TextNiv, TextID, TextEstado);
            JOptionPane.showMessageDialog(null, "El usuario fue "+est+".", "Solicitud finalizada", JOptionPane.PLAIN_MESSAGE);
        }
    }//GEN-LAST:event_BotonAltActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Activar_Users().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton BotonAlt;
