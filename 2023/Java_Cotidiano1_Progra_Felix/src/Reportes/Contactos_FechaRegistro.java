...
public class Contactos_FechaRegistro extends javax.swing.JFrame {
    ...
    public Contactos_FechaRegistro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reporte de Contactos por Fecha de Registro");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(235, 6, -1, 35));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        md.CargarTablaClientesPorFechaRegistro(jTable1, fecha1, fecha2);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Contactos_FechaRegistro().setVisible(true);
            }
        });
    }
