...
public class Contactos_Nombre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reporte de Contactos por Nombre");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(276, 6, -1, 35));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(296, 47, -1, 29));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(379, 47, 223, 29));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        md.CargarTablaClientesPorNombre(jTable1, jTextField1.getText());
    }//GEN-LAST:event_jButton3ActionPerformed

    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Contactos_Nombre().setVisible(true);
            }
        });
    }
